                                ...
                                for pipeline in ["lcm"]:
                                    for reward_switch_epoch in [400]:
                                        ...
                                        for flag in ["zeros","decreasing_scale"]:
                                            ...
                                            command+=f" runaccgpu.sh  --mixed_precision fp16 --num_processes 1 --main_process_port {port} main_logging.py --epochs 500 --limit 5 --batch_size 1 --project_name {data}-{n}-testing "
