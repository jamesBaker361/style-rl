...
sbatch --err=slurm/main/ir_cpu.err --out=slurm/main/ir_cpu.out runpymain.sh main.py --style_layers_train --epochs 1   --gradient_accumulation_steps 1 --sample_num_batches_per_epoch 2 --batch_size 1 --project_name style_test --reward_fn ir
sbatch --exclude=gpu[005,006,011,012],cuda[001,002] --err=slurm/main/ir_gpu.err --out=slurm/main/ir_gpu.out runpygpu.sh main.py --style_layers_train --epochs 1 --gradient_accumulation_steps 1 --sample_num_batches_per_epoch 2 --mixed_precision bf16 --batch_size 1 --project_name style_test --reward_fn ir
