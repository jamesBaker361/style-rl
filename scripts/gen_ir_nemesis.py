            ...
            for num_vectors in [1]:
                for reward_fn in ["qualiclip","ir"]:
                    for prompt_src in ["animals","nature"]:
                        ...
                        name=f"ti_nemesis_{prompt_src}_{reward_fn}_{lr}_{unet}_{pplus}_{num_vectors}"
                        unet_flag={
                            "no-unet":"",
                            "unet":"--train_unet"
                        }[unet]
                        ...
                        command+=f" --validation_epochs 40 --learning_rate {lr} --reward_fn {reward_fn} --nemesis "
                        print(command)