...
from controlnet_aux.segment_anything.automatic_mask_generator import SamAutomaticMaskGenerator
...
class CustomSamDetector:
    ...
    def get_masks(self, input_image: Union[np.ndarray, Image.Image]=None, detect_resolution=512, image_resolution=512,**kwargs)->list:
        if "image" in kwargs:
