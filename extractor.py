#copied from https://github.com/Junyi42/sd-dino/blob/master/extractor_dino.py
...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_path', type=str, default="image.png", help='path of the extracted image.')
