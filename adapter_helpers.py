...
def replace_ip_attn(unet:UNet2DConditionModel,cross_attention_dim:int,embedding_dim:int,num_image_text_embeds:int):
    ...
    unet.encoder_hid_proj=MultiIPAdapterImageProjection([ImageProjection(embedding_dim,cross_attention_dim,num_image_text_embeds)])
