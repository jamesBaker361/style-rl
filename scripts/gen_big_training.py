                        ...
                        for lr in [0.001,0.0001]:
                            for n in [1000]:
                                ...
                                for pipeline in ["lcm","lcm_pre_lora","lcm_post_lora"]:
                                    ...
                                    command+=f" runaccgpu.sh --multi_gpu --mixed_precision fp16 --num_processes 1 --main_process_port {port} main_pers.py --epochs 500 --limit -1 --batch_size 2 --project_name {data}-{n} "
