...
from clipfiqa_models import build_model
from clipfiqa_tokenizer import SimpleTokenizer as _Tokenizer
...
def load(model_path: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit: bool = False, download_root: str = None):
    """Load a CLIP model
