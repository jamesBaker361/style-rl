...
for training_type in ["reward"]:# ["denoise","reward"]:
    for prediction_type in ["epsilon","v_prediction"]:
        for embedding in ["dino","ssl","siglip2","clip"]:
            ...
            command+=f" runaccgpu.sh --multi_gpu --mixed_precision fp16 --num_processes 2 --main_process_port {port} main_pers.py --epochs 2 --limit 10 --batch_size 4 --project_name testing-pers "
