...
sbatch --err=slurm/main/ir_cpu_inv_multi.err --out=slurm/main/ir_cpu_inv_multi.out runpymain.sh main_ir.py --style_layers_train --epochs 1   --gradient_accumulation_steps 1 --sample_num_batches_per_epoch 2 --batch_size 1 --project_name style_test --reward_fn ir --style_layers_train --style_mid_block --prompt_src_txt random_animals.txt --textual_inversion --num_vectors 3
sbatch --exclude=gpu[005,006,011,012],cuda[001,002] --err=slurm/main/ir_gpu_inv_multi.err --out=slurm/main/ir_gpu_inv_multi.out runpygpu.sh main_ir.py --style_layers_train --epochs 1 --gradient_accumulation_steps 1 --sample_num_batches_per_epoch 2 --mixed_precision bf16 --batch_size 1 --project_name style_test --reward_fn ir --style_layers_train --style_mid_block --prompt_src_txt random_animals.txt --textual_inversion --num_vectors 3
